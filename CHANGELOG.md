...
- Initial release.
- `lite-msg`: reads Outlook MSG files from stdin, file arguments, or directories and outputs structured JSONL.
- Extracts headers: From, To, Cc, Bcc, Subject, Date, Message-Id, In-Reply-To, X-Mailer.
- Outputs the same JSON schema as lite-eml for pipeline compatibility.
